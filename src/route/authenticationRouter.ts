...
export class AuthenticationRouter {
    ...
    private setupRoutes() {
        ...
        this.router.post(UserManagementServiceConstants.USER_MANAGEMENT_SERVICE_ACCOUNT_PHONE_SIGNUP_URL_PART, this.signupController.signUpHandler);
        this.router.post(UserManagementServiceConstants.USER_MANAGEMENT_SERVICE_ACCOUNT_PHONE_VERIFY_SIGNUP_URL_PART, this.signupController.signUpHandler);
